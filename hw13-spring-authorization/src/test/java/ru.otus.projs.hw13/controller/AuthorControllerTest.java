...
import ru.otus.projs.hw13.service.AuthorService;
...
class AuthorControllerTest {
    ...
    private static Stream<Arguments> provideArgs4GetAuthorById() {
        return Stream.of(
                Arguments.of(createAuthor(11L), 11L, status().isOk(),
                        new UserInfo("fedor", "1", Arrays.asList(new SimpleGrantedAuthority("MANAGER")))),
                Arguments.of(createAuthor(12L), 12L, status().isForbidden(),null)
        );
    }
