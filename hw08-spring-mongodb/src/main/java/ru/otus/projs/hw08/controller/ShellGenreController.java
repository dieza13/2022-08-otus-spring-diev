...
import ru.otus.projs.hw08.service.GenreService;
...
public class ShellGenreController {
    ...
    private static final String GENRE_WAS_DELETED = "Жанр с id %s был удален";
    ...
    public Genre getGenreById(@ShellOption String genreId) {
